...
#SBATCH --job-name=xrmb_sample2
#SBATCH --output=xrmb_sample2.out
#SBATCH --error=xrmb_sample2.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/xrmb_vs_samples2.m  $MYTMP
...
matlab -nodisplay -nosplash -r "xrmb_vs_samples2, exit"
