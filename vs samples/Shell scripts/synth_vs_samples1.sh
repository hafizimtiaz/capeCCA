...
#SBATCH --job-name=synth_sample1
#SBATCH --output=synth_sample1.out
#SBATCH --error=synth_sample1.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/synth_vs_samples1.m  $MYTMP
...
matlab -nodisplay -nosplash -r "synth_vs_samples1, exit"
