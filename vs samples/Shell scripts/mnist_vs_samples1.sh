...
#SBATCH --job-name=mnist_sample1
#SBATCH --output=mnist_sample1.out
#SBATCH --error=mnist_sample1.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/mnist_vs_samples1.m  $MYTMP
...
matlab -nodisplay -nosplash -r "mnist_vs_samples1, exit"
