...
path = '../datasets/Synth/';
load([path, 'synth_data_d20_K5_N20k_new.mat'])
...
d = 20;
K = 20;
r_x = 0;             % to avoid ill-conditioned matrices
r_y = 0;
S = 10;
R = 2*K;
...
save(['results_vs_eps_synth_d20_K5_N',num2str(N/1000),'k.mat'],...
...
% %% plots
% FS = 24;
% load(['results_vs_eps_synth_d20_K5_N',num2str(N/1000),'k.mat'])
% 
% % for s1
% subplot(131);
...
% semilogx(epsilon_all, CHindex_avg_dp_conv1, 'bsq-','LineWidth',3,'MarkerSize',10); hold on
% semilogx(epsilon_all, CHindex_avg_dp_cape, 'kp-','LineWidth',3,'MarkerSize',10); hold on
% 
% % axis([epsilon_all(idsDP(1))/10 epsilon_all(end)*10 1e-4 1])
% set(gca,'FontSize',FS,'FontWeight','bold')
% xlabel('\epsilon','FontSize',FS,'FontWeight','bold');
...
% % ids = 1:7;
% % 
% % semilogx(epsilon_all, mutInfo_avg_np_pool, 'ro-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, mutInfo_avg_dp_local, 'r*-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, mutInfo_avg_dp_conv1, 'bsq-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, mutInfo_avg_dp_cape, 'kp-','LineWidth',3,'MarkerSize',10); hold on
% % 
% % % axis([epsilon_all(idsDP(1))/10 epsilon_all(end)*10 1e-4 1])
% % set(gca,'FontSize',FS,'FontWeight','bold')
% % xlabel('\epsilon','FontSize',FS,'FontWeight','bold');
...
% % ids = 1:7;
% % 
% % semilogx(epsilon_all, perc_err_avg_np_pool, 'ro-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, perc_err_avg_dp_local, 'r*-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, perc_err_avg_dp_conv1, 'bsq-','LineWidth',3,'MarkerSize',10); hold on
% % semilogx(epsilon_all, perc_err_avg_dp_cape, 'kp-','LineWidth',3,'MarkerSize',10); hold on
% % 
% % % axis([epsilon_all(idsDP(1))/10 epsilon_all(end)*10 1e-4 1])
% % set(gca,'FontSize',FS,'FontWeight','bold')
% % xlabel('\epsilon','FontSize',FS,'FontWeight','bold');
