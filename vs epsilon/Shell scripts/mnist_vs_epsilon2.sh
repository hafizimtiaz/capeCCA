...
#SBATCH --job-name=mnist_eps2
#SBATCH --output=mnist_eps2.out
#SBATCH --error=mnist_eps2.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/mnist_vs_epsilon2.m  $MYTMP	
...
matlab -nodisplay -nosplash -r "mnist_vs_epsilon2, exit"
