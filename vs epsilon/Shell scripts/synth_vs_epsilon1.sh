...
#SBATCH --job-name=synth_eps
#SBATCH --output=synth_eps.out
#SBATCH --error=synth_eps.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/synth_vs_epsilon1.m  $MYTMP
...
matlab -nodisplay -nosplash -r "synth_vs_epsilon1, exit"
