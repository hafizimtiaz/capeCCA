...
#SBATCH --job-name=xrmb_eps
#SBATCH --output=xrmb_eps.out
#SBATCH --error=xrmb_eps.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/xrmb_vs_epsilon1.m  $MYTMP	
...
matlab -nodisplay -nosplash -r "xrmb_vs_epsilon1, exit"
