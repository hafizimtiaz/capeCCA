...
#SBATCH --job-name=mnist_eps
#SBATCH --output=mnist_eps.out
#SBATCH --error=mnist_eps.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/mnist_vs_epsilon1.m  $MYTMP	
...
matlab -nodisplay -nosplash -r "mnist_vs_epsilon1, exit"
