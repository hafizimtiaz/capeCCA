...
#SBATCH --job-name=synth_eps2
#SBATCH --output=synth_eps2.out
#SBATCH --error=synth_eps2.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/synth_vs_epsilon2.m  $MYTMP
...
matlab -nodisplay -nosplash -r "synth_vs_epsilon2, exit"
