...
#SBATCH --job-name=xrmb_del
#SBATCH --output=xrmb_del.out
#SBATCH --error=xrmb_del.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/xrmb_vs_delta.m  $MYTMP	
...
matlab -nodisplay -nosplash -r "xrmb_vs_delta, exit"
