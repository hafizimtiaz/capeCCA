...
path = '../datasets/Synth/';
load([path, 'synth_data_d20_K5_N50k_new.mat'])
...
save(['results_vs_del_synth_d20_K5_N',num2str(N/1000),'k_eps_1.mat'],...
...
% %% plots
% FS = 24;
% load(['results_vs_del_synth_d20_K5_N',num2str(N/1000),'k_eps_1.mat'])
% 
% % for s1
% subplot(131);
% ids = 1:8;
